...
def test_sequence_where_went_to_bed_is_wrong(wrong_points: tuple) -> None:
...
def test_sequence_where_fell_asleep_is_wrong(wrong_points: tuple) -> None:
    points = FakePoints(*wrong_points)
...
def test_sequence_where_woke_up_is_wrong(wrong_points: tuple) -> None:
    points = FakePoints(*wrong_points)
...
def test_sequence_where_got_up_is_wrong(wrong_points: tuple) -> None:
    points = FakePoints(*wrong_points)
...
def test_sequence_all_time_point_can_be_wrong(wrong_points: tuple) -> None:
    points = FakePoints(*wrong_points)
